...
-- ── SPM Additional Mathematics (Form 4) ───────────────────────────
('spm-addmath-f4-live-quiz',    'SPM Form 4 Additional Mathematics Live Quiz', 'spm', 'additional mathematics', 'spm_form4', 'Form4'),
...
('igcse-y4-sci-planet-earth-revision-v2', 'Planet Earth Revision Lab',        'igcse', 'science', 'igcse_y4_science', 'Year4'),
('igcse-y4-sci-earth-space-revision', 'Earth & Space Revision', 'igcse', 'science', 'igcse_y4_science', 'Year4'),
...
--   SELECT COUNT(*) FROM public.modules;         -- should be 52
